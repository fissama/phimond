...
Failure focus: script legacy được báo pass thay active scene, fixture chứa private history, asset nguồn khác phiên bản bị ghi confirmed. Evidence và các giới hạn ở [baseline](P00-baseline.md), [ledger](P00-reference-ledger.md) và [review](P00-review.md).
